# [Moodle Liberal Arts Edition v2.3.8-LAE3.1.1]
...
Moodle 2.3.8+LAE3.1.1 consists of the core Moodle 2.3.8 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v2.3.8-LAE3.1.1
    git checkout -b v2.3.8-LAE3.1.1
